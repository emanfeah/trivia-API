...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_requesting_not_found_category(self):
    ...
    def test_question_search_without_results(self):
        res = self.client().post('/questions', json={'searchTerm': 'EEEEMMMAAN'})
        data = json.loads(res.data)
    ...
    def test_question_based_categore(self):
    ...
    def test_if_categore_not_found(self):
